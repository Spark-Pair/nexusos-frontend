...
export function AuthenticationScreen({
  ...
  return (
    <main className="app-canvas grid min-h-dvh place-items-center p-3 sm:p-6 lg:p-8">
      <AuthenticationFrame toolbar={<ThemeToggle />}>
        <div className="grid gap-7">
          <header className="max-w-sm">
            ...
            <h1 className="mt-2 text-3xl font-bold leading-tight tracking-tight sm:text-[2rem]">
              {title}
            </h1>
