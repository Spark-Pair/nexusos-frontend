  ...
  return (
    <div>
      ...
      <form
        ...
        className="composer-panel flex items-end gap-2 p-2"
      >
        <IconButton
          label="Emoji"
        ...
        <textarea
          ...
          onBlur={() => typing(false)}
          placeholder="Message"
          className="field-control min-h-10 max-h-40 resize-none rounded-full border-transparent bg-white px-4 dark:bg-[#2a3942]"
        />
        <IconButton
          type="submit"
